...
map.getView().fit([-13960291.110184, 4022413.314768, -11005132.120802, 5997437.909280], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">OCTA Preservation Projects - DEMO</h2>';
        return titleElement;
    })(),
